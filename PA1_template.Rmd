...
The 5-minute interval that contains the maximum number of steps, on average across all days in the dataset, is the interval __`r df$Interval[which.max(avg.steps.per.interval$avg.steps)]`__.
